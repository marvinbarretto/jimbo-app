...
import dev.marvinbarretto.jimbo.BatteryStatus
import dev.marvinbarretto.jimbo.CollectorStatus
import dev.marvinbarretto.jimbo.NetworkStatus
import dev.marvinbarretto.jimbo.StatusViewModel
import dev.marvinbarretto.jimbo.SyncState
...
@Composable
fun SettingsScreen(
    state: dev.marvinbarretto.jimbo.SettingsUiState,
    onBack: () -> Unit,
    onSyncNow: () -> Unit,
    onRefresh: () -> Unit,
...
private fun DeadLetterCard(
    deadLetters: List<dev.marvinbarretto.jimbo.DeadLetterUi>,
    onRetry: (String) -> Unit,
