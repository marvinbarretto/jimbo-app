...
Android telemetry app. Collects events from Health Connect, device state, and usage stats, then syncs them to Jimbo API.
...
- `ui/StatusScreen.kt` / `ui/StepsApp.kt` — operational status UI and settings navigation shell.
